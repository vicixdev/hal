...
case "$target_api" in
	Vulkan)
		odin build src -collection:shared=shared -out:build/out -debug -strict-style -vet -warnings-as-errors -define:GFX_TARGET_API=Vulkan -define:GFX_ENABLE_VALIDATION=false
