...
case "$target_api" in
	...
	Metal_3)
		...
		slangc ./shaders/skybox.slang -profile glsl_450 -target metallib	-capability METAL_3_0 -capability GL_EXT_buffer_reference -o ./build/skybox.metallib -fvk-use-entrypoint-name -DGFX_METAL=1
	;;
	*)
